...
> **Tip:**  This is a great way to explore your data!
...
> **Challenge**: 
>
> 1.  Create a facetted plot of sample (x-axis) and genome size (y-axis) broken up by **clade**.  Make the colors of the plot to represent each clade.  
> 2.  Create another facetted plot with sample (x-axis) and genome size (y-axis) broke up by **generation**.  Color the points by the citrate mutant.  What does this tell us about what "unknown" means?  
